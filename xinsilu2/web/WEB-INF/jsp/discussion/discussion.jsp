...
<div class="list_box">
    <div class="list_bor">
        <div class="site_nav w_980">
            ...
            <a href="discussion.action">交流研讨</a>
        </div>
        <div class="w_986">
            <div class="list_sider f_l">
                <h2 class="h2_title list_plate_bg f_family f_normal">
                    <span class="more"></span>交流研讨</h2>
                <div class="content list_plate_bg">
                    <ul class="list_sid_nav">
                        <li>
                            <a href="discussion.action" class="selected">
                                <i class="icon_a icon_all"></i>交流研讨
                            </a>
                        </li>
                    </ul>
                    <div class="clear"></div>
            ...
            <div class="list_main f_r">
                <div class="content list_plate_bg">
                    ...
                    <div class="pager-list">
                        <a href="discussion.action?startPage=${startPage-1}" class="page-item current">上一页</a>
                        <a href="discussion.action?startPage=${startPage}" class="page-item ">${startPage}</a>
                        <a href="discussion.action?startPage=${startPage+1}" class="page-item current">下一页</a>
                    </div>
                </div>
