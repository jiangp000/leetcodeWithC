...
<div class="list_box">
    <div class="list_bor">
        <div class="site_nav w_980">
            ...
            <a href="outputResultJSP">网评结果导出</a>
        </div>
        <div class="w_986">
            <div class="w_986">
                <div class="list_sider f_l">
                    ...
                    <div class="content list_plate_bg">
                        <ul class="list_sid_nav">
                            <li>
                                <a href="outputResultJSP" class="selected">
                                    <i class="icon_a icon_all"></i>网评结果导出
                                </a>
                            </li>
                            <li>
                                <a href="outputScoreJSP">
                                    <i class="icon_a icon_all"></i>评委小分导出
                                </a>
                            </li>
                        </ul>
                        <div class="clear"></div>
                    ...
                    <div class="content list_plate_bg">
                        <div class="list_content">
                            ...
                            <div class="portlet-body form">
                                <form action="outputResult" method="post">
                                    <fieldset>
                                        <div class="form-body">
