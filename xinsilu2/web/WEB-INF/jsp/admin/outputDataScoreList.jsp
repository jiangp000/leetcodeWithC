                ...
                <div class="list_sider f_l">
                    ...
                    <div class="content list_plate_bg">
                        <ul class="list_sid_nav">
                            ...
                            <li>
                                <a href="outputFinalPreScoreJSP">
                                    <i class="icon_a icon_all"></i>结题全部结果
                                </a>
                            </li>
                            <li>
                                <a href="outputDataScoreJSP" class="selected">
                                                        ...
                                                        <td class="col-md-2" >
                                                            <p style="margin:6px 18px;font-size: 15px;line-height: 18px;">
                                                                <a href="${file1}" class="btn btn-default"
                                                                   style="margin-top: 10px; float: left" target="_blank">论文参赛成绩表
                                                                </a>
                                                                <a href="${file2}" class="btn btn-default"
                                                                   style="margin-top: 10px; float: left" target="_blank">结题参赛成绩表
                                                                </a>
                                                            </p>
                                                        </td >
                                                    </tr>
