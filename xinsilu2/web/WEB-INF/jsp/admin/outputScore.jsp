...
<div class="list_box">
    <div class="list_bor">
        <div class="site_nav w_980">
            ...
            <a href="outputResultJSP">评委小分导出</a>
        </div>
        <div class="w_986">
            <div class="w_986">
                <div class="list_sider f_l">
                    ...
                    <div class="content list_plate_bg">
                        <ul class="list_sid_nav">
                            <li>
                                <a href="outputResultJSP">
                                    <i class="icon_a icon_all"></i>网评成绩导出
                                </a>
                            </li>
                            <li>
                                <a href="outputScoreJSP" class="selected">
                    ...
                    <div class="content list_plate_bg">
                        <div class="list_content">
                            ...
                            <div class="portlet-body form">
                                <form action="outputScore" method="post">
                                    <fieldset>
                                        <div class="form-body">
