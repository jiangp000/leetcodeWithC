...
<div class="list_box">
    <div class="list_bor">
        <div class="site_nav w_980">
            ...
            <a href="revokeTeacherSubmitJSP.jsp">教师提交管理</a>
        </div>
        <div class="w_986">
                ...
                <div class="list_sider f_l">
                    ...
                    <div class="content list_plate_bg">
                        <ul class="list_sid_nav">
                            ...
                            <li>
                                <a href="revokeTeacherSubmitJSP" class="selected">
                    ...
                    <div class="content list_plate_bg">
                        <div class="list_content">
                            ...
                            <div class="portlet-body form">
                                <form action="revokeTeacherSubmit" method="post">
                                    <fieldset>
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <label style="margin-right: 10px;width: 100px;">申报者:</label>
