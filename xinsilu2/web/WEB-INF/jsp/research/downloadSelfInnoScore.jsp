...
<div class="list_box">
    <div class="list_bor">
        <div class="site_nav w_980">
            ...
            <a href="researchScoreSearch.action">我的成绩</a>
        </div>
        <div class="w_986">
                ...
                <div class="content list_plate_bg" style="width: 100%;">
                    <div class="list_content">
                        <div class="portlet-body form">
                            <form action="submitResearchScoreSearch" id="researchEnrollForm" enctype="multipart/form-data"
                                  method="post">
                                <fieldset>
                                    <div class="form-body">
                                            ...
                                            <div class="input-group">
                                             <span class="input-group-addon">
                                                ...
                                                <select name="scorePhase" value="scorePhase"
                                                        ...
                                                        data-hide-disabled="true"
                                                        required="true">
                                                    <option value ="网评成绩">网评成绩</option>
                                                    <option value ="现评成绩">现评成绩</option>
                                                    <option value="大赛成绩">大赛成绩</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
