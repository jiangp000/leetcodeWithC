...
<div class="list_sider f_l">
    ...
    <div class="content list_plate_bg">
        <ul class="list_sid_nav">
            <li>
                <a href="innovationResearchEnroll.action" id="column_1">
                    <i class="icon_a icon_all"></i>我的提交
                </a>
            </li>
            <li>
                <a href="innovationResearchFirstTrial.action" id="column_2">
                    <i class="icon_a icon_all"></i>我的初审
                </a>
            </li>
           <%-- <li>
                <a style="text-decoration: none; color:gray; cursor:default;opacity: 1.5" href="javascript:;" id="column_4">
           ...
           <%--<li>
                <a href="researchInnoScoreSearchJSP.action" id="column_4">
                    <i class="icon_a icon_all"></i>我的成绩
                </a>
            </li>--%>
            <li>
                <a href="researchInnoFileJSP.action" id="column_5">
                    <i class="icon_a icon_all"></i>我的下载
                </a>
            </li>
        </ul>
