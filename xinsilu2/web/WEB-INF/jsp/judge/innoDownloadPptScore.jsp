                    ...
                    <div class="list_sider f_l">
                        ...
                        <div class="content list_plate_bg">
                            <ul class="list_sid_nav">
                                ...
                                <li>
                                    <a href="innoDownloadPptScoreJSP" id="column_5" class="selected">
                        ...
                        <div class="content list_plate_bg">
                            <div class="list_content">
                                ...
                                <div class="portlet-body form">
                                    <form action="judgeDownloadPPTScore" method="post">
                                        <fieldset>
                                            <s:textfield type="text" id="scorePhase" name="scorePhase" style="display:none" value="现评"/>
                                            <div class="form-body">
