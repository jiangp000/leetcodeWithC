            ...
            <div class="list_sider f_l">
                ...
                <div class="content list_plate_bg">
                    <ul class="list_sid_nav">
                        ...
                        <li>
                            <a href="uploadFinalScoreTableJSP" id="column_6" class="selected">
...
<%--                                    <input type="file" id="uploadScoreFile" style="display:none;" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet">--%>
                                    ...
                                    <a href="javascript:selectFile()" id="uploadScoreButton" class="btn btn-default">上传结题报告评分表</a>
...
<script>
    ...
    // 将解析的csv文件转换为字符串传输
    // 格式 [[uid1,score0~10][uid2,score0~10]]
    function uploadScores(csv){
        ...
        rows.forEach((row,idx)=>{
            ...
            scores.push(columns[18]);
            let comment = columns[20];
            let project_id = columns[21];
