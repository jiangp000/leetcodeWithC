...
<head>
    ...
    <script>
        ...
        $(document).ready(function(){
            var options = {
                totalPages : ${fn:length(projectEnrollList)},
                numberOfPages: 10,
                currentPage: ${id},
                pageUrl: function(type, page, current){
                    if (page==current) {
                        ...
                        return "scoreProjectJSP?id="+page;
                    }
                }
            }
                    ...
                    <div class="list_content">
                        <div>
                            <ul id="pagination" class="pagination">
                                ...
                                <c:forEach var="item" items="${projectEnrollList}" varStatus="s">
                                    <c:if test="${item.id == projectEnroll.id}">
                                        <li class="active"><a href="scoreProjectJSP?projectScore.projectEnrollId=${item.id}">${item.id}</a></li>
                                    </c:if>
                                    <c:if test="${item.id != projectEnroll.id}">
                                        <li ><a href="scoreProjectJSP?projectScore.projectEnrollId=${item.id}">${item.id}</a></li>
                                    </c:if>
                                </c:forEach>
                        ...
                        <div class="portlet-body form">
                            <form action="submitProjectScore?id=${id}"
                                  id="projectScoreForm" enctype="multipart/form-data"
                                  method="post">
                                <fieldset>
                                    <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="input-group-addon">
                                                    ...
                                                    <s:textarea class="form-control" name="projectEnroll.userCV"
                                                                maxlength="500"
                                                                style="min-height:180px; border:2px solid;"
                                                                disabled="true"/>
                                                </div>
                                            </div>
                                        </c:if>--%>
                                       <%-- <div class="form-group">--%>
                                            ...
                                            <%--<a href="${projectEnroll.filePath}" class="btn btn-default"
                                               style="margin-top: 10px;" target="_blank">浏览附件</a>
                                        </div>--%>
                                        <div class="form-group">
                                            <label>案例实录视频</label>
                                            <video id="project_video"  controls   preload="auto"  style="width: 100%">
                                                <source src="/upload/xinsilu/researchEnroll/2021/创新大赛/${projectEnroll.userId}-${projectEnroll.username}/${projectEnroll.title}_${projectEnroll.username}_授课内容.mp4" type='video/mp4' />
                                            </video>
                                            <a href="/upload/xinsilu/researchEnroll/2021/创新大赛/${projectEnroll.userId}-${projectEnroll.username}/${projectEnroll.title}_${projectEnroll.username}_实录信息表.docx" class="btn btn-default"
                                       ...
                                       <div class="form-group">
                                       <%-- <iframe src='https://view.officeapps.live.com/op/view.aspx?src=http://jpk.pku.edu.cn${projectEnroll.filePath}' width='100%' height='100%' frameborder='1'>
                                        </iframe>--%>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <table class="table" style="width:680px">
                                                <tr>
                                                    <td class="col-md-2" >
                                                        <p style="margin:6px 18px;font-size: 15px;line-height: 18px;">
                                                            <a href="/upload/xinsilu/researchEnroll/2021/创新大赛/${projectEnroll.userId}-${projectEnroll.username}/${projectEnroll.title}_${projectEnroll.username}_申报书.pdf" class="btn btn-default"
                                                               style="margin-top: 10px; float: left" target="_blank">申报书
                                                            </a>
                                                            <a href="/upload/xinsilu/researchEnroll/2021/创新大赛/${projectEnroll.userId}-${projectEnroll.username}/${projectEnroll.title}_${projectEnroll.username}_教学大纲.docx" class="btn btn-default"
                                                               style="margin-top: 10px; float: left" target="_blank">教学大纲
                                                            </a>
                                                            <a href="/upload/xinsilu/researchEnroll/2021/创新大赛/${projectEnroll.userId}-${projectEnroll.username}/${projectEnroll.title}_${projectEnroll.username}_案例概述.docx" class="btn btn-default"
                                                               style="margin-top: 10px; float: left" target="_blank">案例概述
                                                            </a>
                                                            <a href="/upload/xinsilu/researchEnroll/2021/创新大赛/${projectEnroll.userId}-${projectEnroll.username}/${projectEnroll.title}_${projectEnroll.username}_案例设计.docx" class="btn btn-default"
                                                               style="margin-top: 10px; float: left" target="_blank">案例设计
                                                            </a>
                                                            <a href="/upload/xinsilu/researchEnroll/2021/创新大赛/${projectEnroll.userId}-${projectEnroll.username}/${projectEnroll.title}_${projectEnroll.username}_课件.ppt" class="btn btn-default"
                                                               style="margin-top: 10px; float: left" target="_blank">案例课件(ppt)
                                                            </a>
                                                            <a href="/upload/xinsilu/researchEnroll/2021/创新大赛/${projectEnroll.userId}-${projectEnroll.username}/${projectEnroll.title}_${projectEnroll.username}_其它材料.zip" class="btn btn-default"
                                                    ...
                                                    <td class="col-md-2" style="font-size: 16px ">
                                                        <p style="margin:6px 18px;font-size: 15px;line-height: 18px;">
                                                            ...
                                                            <s:textfield id="documentScore" style="height:24px; width:70px; float:right;" class="form-control"
                                                                         name="projectScore.documentScore"
                                                                         readonly = "true"
                                                                         required="true" type="number"/>
                                                        </p>
                                                    </td>
                                    ...
                                    <div style="margin-top: 10px; margin-bottom: 10px; text-align: center">
                                        <button type="submit" class="btn blue-madison"
                                                onclick="validate_projectScoreForm()">
