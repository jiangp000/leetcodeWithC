                    ...
                    <div class="list_sider f_l">
                        ...
                        <div class="content list_plate_bg">
                            <ul class="list_sid_nav">
                                <li>
                                    <a href="applyScoreJSP?id=1" id="column_2">
                                ...
                                <li>
                                    <a href="applyDownloadFileJSP" id="column_5" class="selected">
                                                                ...
                                                                <td class="col-md-2" >
                                                                    <p style="margin:6px 18px;font-size: 15px;line-height: 18px;">
                                                                        <a href="${file1}" class="btn btn-default"
                                                                           style="margin-top: 10px; float: left" target="_blank">${year}项目申报资料.zip
                                                                        </a>
                                                                        <%--<a href="${file3}" class="btn btn-default"
                                                                           style="margin-top: 10px; float: left" target="_blank">${year}}项目申报分数表下载
                                                                        </a>--%>
