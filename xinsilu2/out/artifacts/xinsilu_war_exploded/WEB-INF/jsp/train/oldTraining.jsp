            ...
            <div class="list_main f_r">
                <div class="content list_plate_bg">
                    ...
                    <div class="pager-list">
                        <a href="oldTraining.action?startPage=${startPage-1}" class="page-item current">上一页</a>
                        <a href="oldTraining.action?startPage=${startPage}" class="page-item ">${startPage}</a>
                        <a href="oldTraining.action?startPage=${startPage+1}" class="page-item current">下一页</a>
                    </div>
                </div>
