...
<div class="list_box">
    <div class="list_bor">
        <div class="site_nav w_980">
            ...
            <a href="researchMiddleFileJSP.action">我的下载</a>
        </div>
        <div class="w_986">
                ...
                <div class="content list_plate_bg" style="width: 100%;">
                    <div class="list_content">
                        <div class="portlet-body form">
                            <form action="submitMiddleFileDownload" id="researchEnrollForm" enctype="multipart/form-data"
                                  method="post">
                                <fieldset>
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="input-group-addon">
                                                <i class="glyphicon glyphicon-user"></i>
                                                    ...
                                                    <s:textfield class="form-control" name="userId" readonly="true"
