...
<div class="list_box">
    <div class="list_bor">
        <div class="site_nav w_980">
            ...
            <a href="researchInnoScoreSearchJSP.action">我的成绩</a>
        </div>
        <div class="w_986">
                ...
                <div class="content list_plate_bg" style="width: 100%;">
                    <div class="list_content">
                        <div class="portlet-body form">
                            <form action="submitResearchInnoScoreSearch" id="researchEnrollForm" enctype="multipart/form-data"
                                  method="post">
                                <fieldset>
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <span class="input-group-addon">
                                                ...
                                                <s:textfield class="form-control" name="userId"
                                                             required="true"/>
                                            </div>
                                        </div>
                                        <%--<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                             <span class="input-group-addon">
                                                ...
                                                <select name="scorePhase" value="scorePhase"
                                                        class="selectpicker form-control"
                                                        data-live-search="true"
                                                        data-hide-disabled="true"
                                                        required="true">
                                                    <option value ="网评分数">网评成绩</option>
                                                    <option value ="现评分数">现评成绩</option>
                                                    <option value="大赛分数">大赛成绩</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
