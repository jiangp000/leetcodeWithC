...
<div class="list_sider f_l">
    ...
    <div class="content list_plate_bg">
        <ul class="list_sid_nav">
            <li>
                <a href="InnovationEnroll.action" id="column_1">
                    <i class="icon_a icon_all"></i>我的提交
                </a>
            </li>
            <!--<li>
                <a href="researchScoreSearch.action" id="column_2">
                    <i class="icon_a icon_all"></i>我的成绩
               </a>
            </li>
            <li>
                <a href="researchFileDownload.action" id="column_3">
                   <i class="icon_a icon_all"></i>我的下载
                </a>
            </li>-->
            <!-- <li>
                <a href="finalResearchEnroll.action" id="column_4">
                    <i class="icon_a icon_all"></i>结题报告提交
                </a>
            </li> -->
        </ul>
        <div class="clear"></div>
