                ...
                <div class="list_sider f_l">
                    ...
                    <div class="content list_plate_bg">
                        <ul class="list_sid_nav">
                            ...
                            <li>
                                <a href="outputResultScoreJSP" class="selected">
                    ...
                    <div class="content list_plate_bg">
                        <div class="list_content">
                            ...
                            <div class="portlet-body form">
                                <form action="outputResultScore" method="post">
                                    <fieldset>
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <label style="margin-right: 10px;width: 100px;">评分阶段:</label>
                                                    <select name="scoreType"
                                                            class="selectpicker form-control"
                                                            data-live-search="true"
                                                            data-hide-disabled="true">
                                                        <option value ="网评分数">网评分数</option>
                                                        <option value ="最终分数">最终分数</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <label style="margin-right: 10px;width: 100px;">有无评委姓名</label>
                                                    <select name="haveJudgeName"
                                                            class="selectpicker form-control"
                                                            data-live-search="true"
                                                            data-hide-disabled="true">
                                                        <option value ="管理员">管理员</option>
                                                        <option value ="给评委">给评委</option>
                                                    </select>
                                                </div>
                                            </div>
