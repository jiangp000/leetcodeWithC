                ...
                <div class="list_sider f_l">
                    ...
                    <div class="content list_plate_bg">
                        <ul class="list_sid_nav">
                            ...
                            <li>
                                <a href="scoreStageControlJSP" class="selected">
                    ...
                    <div class="content list_plate_bg">
                        <div class="list_content">
                            ...
                            <div class="portlet-body form">
                                <form action="scoreStageControl" method="post">
                                    <fieldset>
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <select name="stageType"
                                                        ...
                                                        <option value ="网评">网评</option>
                                                        <option value ="现评">现评</option>
                                                    </select>
                                                </div>
                                            </div>
...
<%--                                                        <option value ="初审">初审</option>--%>
<%--                                                    </select>--%>
<%--                                                    &lt;%&ndash;<s:textfield class="form-control"--%>
<%--                                                                 name="judgeName" id="judgeNameId"--%>
<%--                                                                 value="无"/>&ndash;%&gt;--%>
<%--                                                </div>--%>
<%--                                            </div>--%>
