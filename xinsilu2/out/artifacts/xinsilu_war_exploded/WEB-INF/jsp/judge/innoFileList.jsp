                    ...
                    <div class="list_sider f_l">
                        ...
                        <div class="content list_plate_bg">
                            <ul class="list_sid_nav">
                                ...
                                <li>
                                    <a href="innoScoreJSP?id=1" id="column_2">
                                ...
                                <li>
                                    <a href="innoDownloadFileJSP" id="column_7" class="selected">
                                                                ...
                                                                <td class="col-md-2" >
                                                                    <p style="margin:6px 18px;font-size: 15px;line-height: 18px;">
                                                                        <a href="${file1}" class="btn btn-default"
                                                                           style="margin-top: 10px; float: left" target="_blank">${year}教师参赛资料.zip
                                                                        </a>
                                                                        <a href="${file2}" id="activityData" class="btn btn-default"
                                                                           style="margin-top: 10px; float: left; pointer-events: none" target="_blank">${year}大赛活动资料
                                                                        </a>
                                                                    </p>
                                                                </td >
                                                            </tr>
