 ...
 */
public class DownloadApplyResultScore {
    // 所在组
    ...
    public String toString() {
        return "DownloadAllScore{" +
                ...
                ", projectEthicSort='" + projectEthicSort + '\'' +
                ", projectEthicSort='" + projectApplySort + '\'' +
                ", isPass='" + isPass + '\'' +
                ", applyPreComment='" + applyPreComment + '\'' +
                ", applyId='" + applyId + '\'' +
                ", userCv='" + userCv + '\'' +
                ", userTitle='" + userTitle + '\'' +
                ", userPhone='" + userPhone + '\'' +
    ...
    public String toCSVStr() {
        return projectNo + ","+
                userId + "," + userName + "," + deptName + "," + title + "," +
                projectSort + "," + caseSort + "," + teamMember + "," + teamNumber + "," + projectEthicSort + "," +
                projectApplySort + "," + isPass + "," + applyPreComment+ "," + applyId + "," +
                userCv + "," + userTitle + "," + userPhone + "," + userMail + "," +
                String.valueOf(judgeScore1) + "," +
