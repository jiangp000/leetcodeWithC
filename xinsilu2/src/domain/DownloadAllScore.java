...
public class DownloadAllScore {
    ...
    public String toString() {
        return "DownloadAllScore{" +
                ...
                ", videoScore1=" + videoScore1 +
                ", videoScore2=" + videoScore2 +
                ", videoScore3=" + videoScore3 +
                ", videoScore4=" + videoScore4 +
                ", videoScore5=" + videoScore5 +
                ", documentScore=" + documentScore +
                ", documentScore1=" + documentScore1 +
                ", documentScore2=" + documentScore2 +
                ", documentScore3=" + documentScore3 +
                ", documentScore4=" + documentScore4 +
                ", score=" + score +
    ...
    public String toCSVStr() {
        return group + "," + judgeId + "," + judgename + "," +
                userId + "," + username + "," + title + "," + String.valueOf(videoScore1) + "," +
